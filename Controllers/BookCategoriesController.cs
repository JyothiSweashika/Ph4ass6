...
namespace Assignment6.Controllers
{
    public class BookCategoriesController : Controller
    {
        ...
        public BookCategoriesController(Db123Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.BookCategories != null ? 
                          ...
                          Problem("Entity set 'Db123Context.BookCategories'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Db123Context.BookCategories'  is null.");
            }
            var bookCategory = await _context.BookCategories.FindAsync(id);
            if (bookCategory != null)
            {
